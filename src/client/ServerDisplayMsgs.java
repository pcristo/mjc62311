...
public class ServerDisplayMsgs
{
	...
	private final static String EXCHANGE_OPERATIONS = "1.Get Business Info\n2.update SharePrice\n3.register Business\n4.unregister Business\n5.exit";
	...
	public static int printExchangeServerOptions()
	{
		System.out.println(SEPARATOR);
		System.out.println(EXCHANGE_OPERATIONS);
		System.out.println(SEPARATOR);
