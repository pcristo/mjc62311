...
public class BusinessInfoHelper
{
    ...
    {
        a.insert_Streamable(new BusinessInfoHolder(t));
    }
    ...
    public static BusinessInfo extract( org.omg.CORBA.Any a )
    {
        ...
        if (HAS_OPENORB && a instanceof org.openorb.orb.core.Any) {
            ...
            try {
                ...
                if ( s instanceof BusinessInfoHolder )
                    return ( ( BusinessInfoHolder ) s ).value;
            }
            catch ( org.omg.CORBA.BAD_INV_ORDER ex )
            {
            }
            BusinessInfoHolder h = new BusinessInfoHolder( read( a.create_input_stream() ) );
    ...
    private final static String _id = "IDL:exchangeServer/BusinessInfo:1.0";
    ...
    {
        BusinessInfo new_one = new BusinessInfo();
