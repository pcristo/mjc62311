        ...
        implements ExchangeServerIFOperations, org.omg.CORBA.portable.InvokeHandler
{
    ...
    private org.omg.CORBA.portable.OutputStream _invoke_getBusiness(
        ...
        corba.exchange_server_domain.ExchangeServerIFPackage.BusinessInfo _arg_result = getBusiness(arg0_in);

        _output = handler.createReply();
        corba.exchange_server_domain.ExchangeServerIFPackage.BusinessInfoHelper.write(_output,_arg_result);
