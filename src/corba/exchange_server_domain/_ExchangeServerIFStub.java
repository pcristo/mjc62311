        ...
        while(true)
        {
            if (!this._is_local())
            {
                ...
                try
                {
                    ...
                    corba.exchange_server_domain.ExchangeServerIFPackage.BusinessInfo _arg_ret = corba.exchange_server_domain.ExchangeServerIFPackage.BusinessInfoHelper.read(_input);
                    return _arg_ret;
                }
