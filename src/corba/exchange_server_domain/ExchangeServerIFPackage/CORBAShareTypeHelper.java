...
public class CORBAShareTypeHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, corba.exchange_server_domain.ExchangeServerIFPackage.CORBAShareType t)
    {
        a.type(type());
     ...
     */
    public static corba.exchange_server_domain.ExchangeServerIFPackage.CORBAShareType extract( org.omg.CORBA.Any a )
    {
     ...
     */
    public static corba.exchange_server_domain.ExchangeServerIFPackage.CORBAShareType read(org.omg.CORBA.portable.InputStream istream)
    {
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, corba.exchange_server_domain.ExchangeServerIFPackage.CORBAShareType value)
    {
