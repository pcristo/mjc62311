...
abstract public class corShareItemHelper
{
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[4] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (exchange_domain.iExchangePackage.corShareItemHelper.id (), "corShareItem", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    exchange_domain.iExchangePackage.corShareItem value = new exchange_domain.iExchangePackage.corShareItem ();
