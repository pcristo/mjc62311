...
abstract public class customerHelper
{
  ...
  public static void insert (org.omg.CORBA.Any a, exchange_domain.iExchangePackage.customer that)
  {
  ...
  public static exchange_domain.iExchangePackage.customer extract (org.omg.CORBA.Any a)
  {
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[6] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (exchange_domain.iExchangePackage.customerHelper.id (), "customer", _members0);
          __active = false;
        }
      }
    }
  ...
  public static exchange_domain.iExchangePackage.customer read (org.omg.CORBA.portable.InputStream istream)
  {
    exchange_domain.iExchangePackage.customer value = new exchange_domain.iExchangePackage.customer ();
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, exchange_domain.iExchangePackage.customer value)
  {
