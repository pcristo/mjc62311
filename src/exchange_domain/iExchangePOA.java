 ...
 implements exchange_domain.iExchangeOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  // update share price
       ...
       {
         exchange_domain.iExchangePackage.corShareItem corShares[] = exchange_domain.iExchangePackage.lstCorShareItemHelper.read (in);
         exchange_domain.iExchangePackage.customer corCustomer = exchange_domain.iExchangePackage.customerHelper.read (in);
