...
public class _iExchangeStub extends org.omg.CORBA.portable.ObjectImpl implements exchange_domain.iExchange
{
  ...
  public void clientOrder (exchange_domain.iExchangePackage.corShareItem[] corShares, exchange_domain.iExchangePackage.customer corCustomer)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("clientOrder", true);
                exchange_domain.iExchangePackage.lstCorShareItemHelper.write ($out, corShares);
                exchange_domain.iExchangePackage.customerHelper.write ($out, corCustomer);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
